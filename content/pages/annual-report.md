...
<!--              <div class="mb-2">-->
<!--                <ul>-->
<!--                  <li class="h4">90% growth in full-content legislative documents</li>-->
...
<!--                <a href="https://laws.africa/2021/06/30/uganda-national-legislation-collection.html" target="_blank">-->
<!--                  How we launched the Uganda Grey Book 2021-->
<!--                </a>-->
<!--              </div>-->
<!--              <div class="h4">-->
<!--                <q>-->
<!--                  The Uganda Law Reform Commission completed the last official revision and consolidation of the Laws-->
<!--                  of Uganda in the early 2000s. It updated legislation up to and including 31 December 2001-->
<!--                </q>-->
<!--              </div>-->
            </div>
          ...
          <section class="mb-4">
            ...
            <div class="callout-box mb-4">
              Lorem Callout
<!--              <ul>-->
<!--                <li class="h4">9,930 new gazettes added in the last year</li>-->
<!--                <li class="h4">-->
<!--                  4 new jurisdictions: Ghana, Seychelles, Sierra Leone, and the East African Economic Community-->
<!--                  (EAC).-->
<!--                </li>-->
<!--                <li>-->
...
<!--              </ul>-->
            ...
            <div class="callout-box mb-4">
              Lorem Callout
<!--              <ul>-->
<!--                <li class="h4">Help preserve Gazettes before more are lost</li>-->
<!--              </ul>-->
            </div>
          ...
          <section class="mb-4">
            ...
            <div class="callout-box">
              Lorem Callout
<!--              <div>-->
<!--                <q>Read more about our new advisory board members</q>-->
<!--              </div>-->
            </div>
          </section>
        </article>
...
<script type="text/javascript">
  document.addEventListener("DOMContentLoaded", function () {
    {
      var ulElement = document.querySelector('.annual-report-topic-list');
      var topicsNodes = document.querySelectorAll("[data-tocify='#toc'] h2");
      for (let i = 0; i < topicsNodes.length; i++) {
        var liElement = document.createElement('li');
        liElement.classList.add('annual-report-topic-list__item');
        var anchorElement = document.createElement('a');
        anchorElement.classList.add('h4');
        anchorElement.href = "#" + topicsNodes[i].id;
        anchorElement.innerText = topicsNodes[i].innerText;
        var bulletElement = document.createElement('div');
        bulletElement.classList.add('annual-report-topic-list__item__marker');
        liElement.append(bulletElement, anchorElement);
