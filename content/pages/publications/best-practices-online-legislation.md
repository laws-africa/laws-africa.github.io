...
## 1.1 Optimise for readability and understanding
...
## 1.2 Understand your user and their needs
...
## 1.3 Build for mobile phones first
...
## 1.4 Follow web accessibility guidelines
...
## 2.2 Use a reasonable font size
...
## 2.3 Use sufficient line heights and paragraph spacing
...
## 2.4 Avoid using justified text
...
## 3.1 Apply formatting consistently
...
## 3.2 Differentiate between authoritative content and editorial insertions
...
<img src="/static/img/posts/indentation.png" class="img-fluid" style="max-width: 500px" alt="Indentation example">
...
## 4.1 Don’t assume all screens or pages are the same width
...
## 4.3 Use percentages for table column widths
...
<img src="/static/img/posts/table-scroll.gif" class="img-fluid" style="max-width: 300px" alt="Scrolling table example">
...
## 5.1 Help the reader understand where they are in the document
...
## 5.2 Help the user to navigate the document
